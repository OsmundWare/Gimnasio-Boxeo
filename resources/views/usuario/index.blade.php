                                ...
                                @foreach($usuarios as $usuario)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class='btn btn-xs btn-default' onclick="return confirm('¿Está seguro que desea eliminar este registro?')" data-original-title='Cancel'  href="{!! URL::to('/usuario/'.$usuario->id_usuario.'/eliminar') !!}"><i class='fa fa-times'></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
