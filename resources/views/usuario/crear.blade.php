...
@section('Breadcrumb')
    <ol class="breadcrumb">
        <li>Inicio</li><li><a href="{!! URL::to('/usuario/index') !!}">Listado de Usuarios</a></li> <li>Ingresar Usuario</li>
    </ol>
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        {!! Form::open(['url' => 'usuario','files'=> true, 'class'=>'smart-form','id'=>'checkout-form', 'novalidate'=>'novalidate']) !!}
